...
import {FaBars, FaFacebook, FaGithub, FaInstagram, FaLinkedin, FaTimes, FaViber} from "react-icons/fa";
...
const Navbar = () => {
    ...
    return (
        <div className={"fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#0a192f] text-gray-300"}>
            ...
            <ul className={nav ? "hidden" : "absolute top-0 left-0 w-full h-screen bg-black flex flex-col justify-center items-center sm:hidden"}>
            ...
            <div className='hidden lg:flex fixed flex-col top-[35%] left-0'>
                <ul>
                    <li className='w-[160px] h-[50px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#833AB4]'>
                        <a
                    ...
                    <li className='w-[160px] h-[50px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#7360f2]'>
                        <a
                            className='flex justify-between items-center w-full text-gray-300'
                            href='/'
                        >
                            Viber <FaViber size={30} />
                        </a>
                    </li>
